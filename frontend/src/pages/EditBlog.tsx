      ...
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold py-3 rounded-2xl transition-colors duration-300 ease-in-out hover:from-pink-500 hover:to-purple-500"
          >
            Update Blog
          </button>
        </div>
