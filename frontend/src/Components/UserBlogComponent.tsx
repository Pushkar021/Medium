...
<Link to={`edit/${id}`}>
            <button className="ml-2 bg-slate-900 text-white w-20 h-8 flex items-center justify-center p-2 rounded-2xl hover:scale-105 hover:bg-slate-700 transition-all duration-300">
              Edit Blog
            </button>
</Link>
            <button onClick={handleclick} className="ml-2 bg-red-900 text-white w-20 h-8 flex items-center justify-center p-2 rounded-2xl hover:scale-105 hover:bg-red-700 transition-all duration-300">
              Delete Blog
            </button>
          </div>
